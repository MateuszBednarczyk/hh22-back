...
CREATE TABLE public.civic_projects_authors
(
    civic_project_entity_id bigint NOT NULL,
    authors_user_id         bigint NOT NULL
);
...
ALTER TABLE ONLY public.civic_projects_authors
    ADD CONSTRAINT fk5x8556ik409sxbdde06h2xlv6 FOREIGN KEY (civic_project_entity_id) REFERENCES public.civic_projects (id);
...
ALTER TABLE ONLY public.civic_projects_authors
    ADD CONSTRAINT fkgj0mem9oa12f9gkwwt2fegohj FOREIGN KEY (authors_user_id) REFERENCES public.users (user_id);
