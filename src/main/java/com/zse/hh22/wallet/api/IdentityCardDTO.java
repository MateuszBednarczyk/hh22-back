...
public record IdentityCardDTO(DocumentStatus documentStatus, DocumentType documentType, ImageLinkDTO picture,
                              String firstName, String secondName, String surname, String nationality,
                              String documentNumber, Date expiryDate, Date birthDate, Sex sex, String CAN,
                              String placeOfBirth, String pesel, String familyName, String motherName,
                              String fatherName, String issuingAuthority, Date dateOfIssue) {
}
